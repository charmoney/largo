		...
		register_taxonomy(
			...
			array(
				...
				'labels'        => array(
					...
					'not_found'             => __( 'No post prominences found.' ),
					'no_terms'              => __( 'No post prominences' ),
					'items_list_navigation' => __( 'Post Prominences list navigation' ),
					'items_list'            => __( 'Post Prominences list' ),
					'back_to_items'         => __( '&larr; Back to Post Prominences' ),
				),
				'query_var'     => true,
				'rewrite'       => true,
			)
		...
		register_taxonomy(
			...
			array(
				...
				'labels' => array(
					...
					'parent_item'           => __( 'Parent Post Types' ),
					'parent_item_colon'     => __( 'Parent Post Types:' ),
					'not_found'             => __( 'No post types found.' ),
					'no_terms'              => __( 'No post types' ),
					'items_list_navigation' => __( 'Post Types list navigation' ),
					'items_list'            => __( 'Post Types list' ),
					'back_to_items'         => __( '&larr; Back to Post Types' ),
				),
				'public' => $enabled,
		...
		register_taxonomy(
			...
			array(
				...
				'labels' => array(
					...
					'back_to_items'         => __( '&larr; Back to Series' ),
				),
